...
class TblAdaptRegionalData(Base):
    __tablename__ = 'tbl_adapt_regional_data'
    __table_args__ = (
        ForeignKeyConstraint(['adaptation_optcode_id'], ['lkp_adapt_regional_optcode.id'], name='tbl_adapt_regional_data_ibfk_8'),
        ForeignKeyConstraint(['adaptation_prefix_id'], ['lkp_adapt_regional_color.id'], name='tbl_adapt_regional_data_ibfk_7'),
        ForeignKeyConstraint(['change_metric_id'], ['lkp_change_metric.id'], name='tbl_adapt_regional_data_ibfk_4'),
        ForeignKeyConstraint(['climate_scenario_id'], ['lkp_climate_scenario.id'], name='tbl_adapt_regional_data_ibfk_3'),
        ForeignKeyConstraint(['country_id'], ['lkp_country.id'], name='tbl_adapt_regional_data_ibfk_5'),
        ForeignKeyConstraint(['district_id'], ['lkp_district.id'], name='tbl_adapt_regional_data_ibfk_7'),
        ForeignKeyConstraint(['intensity_metric_id'], ['lkp_intensity_metric.id'], name='tbl_adapt_regional_data_ibfk_1'),
        ForeignKeyConstraint(['state_id'], ['lkp_state.id'], name='tbl_adapt_regional_data_ibfk_6'),
        ForeignKeyConstraint(['visualization_scale_id'], ['lkp_visualization_scale.id'], name='tbl_adapt_regional_data_ibfk_2'),
        Index('adaptation_optcode_id', 'adaptation_optcode_id'),
        Index('adaptation_prefix_id', 'adaptation_prefix_id'),
        Index('change_metric_id', 'change_metric_id'),
        Index('climate_scenario_id', 'climate_scenario_id'),
    ...
    pop_nil: Mapped[Optional[float]] = mapped_column(Float)
    # Forward relationships only - no need of back_populates
    adaptation_optcode: Mapped[Optional['LkpAdaptRegionalOptcode']] = relationship('LkpAdaptRegionalOptcode')
    adaptation_prefix: Mapped[Optional['LkpAdaptRegionalColor']] = relationship('LkpAdaptRegionalColor')
    change_metric: Mapped[Optional['LkpChangeMetric']] = relationship('LkpChangeMetric')
    climate_scenario: Mapped[Optional['LkpClimateScenario']] = relationship('LkpClimateScenario')
    country: Mapped[Optional['LkpCountry']] = relationship('LkpCountry')
    district: Mapped[Optional['LkpDistrict']] = relationship('LkpDistrict')
